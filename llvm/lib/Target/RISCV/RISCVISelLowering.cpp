...
static MachineBasicBlock *addVSetVL(MachineInstr &MI, MachineBasicBlock *BB,
  ...
  case 0:
    Multiplier = RISCVVLengthMultiplier::LMul1;
    break;
  case 1:
    Multiplier = RISCVVLengthMultiplier::LMul2;
    break;
  case 2:
    Multiplier = RISCVVLengthMultiplier::LMul4;
    break;
  case 3:
    Multiplier = RISCVVLengthMultiplier::LMul8;
    break;
  case 5:
    Multiplier = RISCVVLengthMultiplier::LMulF8;
    break;
  case 6:
    Multiplier = RISCVVLengthMultiplier::LMulF4;
    break;
  case 7:
    Multiplier = RISCVVLengthMultiplier::LMulF2;
    break;
  }
  ...
  MIB.addImm(((Multiplier & 0x4) << 3) | (ElementWidth << 2) |
             (Multiplier & 0x3));
